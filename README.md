...
- **Historiku** — view, filter, edit, delete past actions; success snackbars; product labels `Emri (Kodi)` (requires `docs/sql/05_veprim_batch.sql`; Ora/Pershkrimi require `docs/sql/06_veprim_batch_ora_pershkrimi.sql`)
