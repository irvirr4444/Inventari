...
function LlojiIcon(props: { children: React.ReactNode }) {
  return (
    <svg
      aria-hidden="true"
      width="18"
...
export function LlojiTransferIcon() {
  return (
    <LlojiIcon>
      <path d="M7 7h11l-3-3" />
      <path d="M18 7l-3 3" />
...
export function TabProdukteIcon() {
  return (
    <TabIcon>
